            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    backgroundColor: 'var(--bg)',
                    border: `2px solid ${errors.firstName ? 'var(--error)' : 'var(--border)'}`,
                    color: 'var(--text-primary)'
                  }}
                />
                {errors.firstName && (
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    backgroundColor: 'var(--bg)',
                    border: `2px solid ${errors.lastName ? 'var(--error)' : 'var(--border)'}`,
                    color: 'var(--text-primary)'
                  }}
                />
                {errors.lastName && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: 'var(--bg)',
                      border: `2px solid ${errors.contactNumber ? 'var(--error)' : 'var(--border)'}`,
                      color: 'var(--text-primary)'
                    }}
                  />
                </div>
              ...
              <div>
                <label className="block text-sm font-semibold mb-2" 
                       style={{ color: 'var(--text-primary)' }}>
                  National ID / Passport <span style={{ color: 'var(--error)' }}>*</span>
                </label>
                <div className="relative">
                  <CreditCard className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" 
                              style={{ color: 'var(--text-secondary)' }} />
                  <input
                    {...register('nationalId', { 
                    ...
                    style={{
                      backgroundColor: 'var(--bg)',
                      border: `2px solid ${errors.nationalId ? 'var(--error)' : 'var(--border)'}`,
                      color: 'var(--text-primary)'
                    }}
                  />
                </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" 
                             style={{ color: 'var(--text-secondary)' }} />
                  <select
                    {...register('incomeSource', { required: 'Please select income source' })}
                    className="w-full pl-10 pr-4 py-3 rounded-lg outline-none appearance-none cursor-pointer"
                    style={{
                      backgroundColor: 'var(--bg)',
                      border: `2px solid ${errors.incomeSource ? 'var(--error)' : 'var(--border)'}`,
                      color: 'var(--text-primary)'
                    }}
                  >
              ...
              <div>
                <label className="block text-sm font-semibold mb-2" 
                       style={{ color: 'var(--text-primary)' }}>
                  Monthly Income ($) <span style={{ color: 'var(--error)' }}>*</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{
                      backgroundColor: 'var(--bg)',
                      border: `2px solid ${errors.monthlyIncome ? 'var(--error)' : 'var(--border)'}`,
                      color: 'var(--text-primary)'
                    }}
                  />
                </div>
              ...
              <div>
                <label className="block text-sm font-semibold mb-2" 
                       style={{ color: 'var(--text-primary)' }}>
                  Requested Loan Amount ($) <span style={{ color: 'var(--error)' }}>*</span>
                </label>
                <div className="relative">
                  <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" 
                              style={{ color: 'var(--text-secondary)' }} />
                  <input
                    ...
                    style={{
                      backgroundColor: 'var(--bg)',
                      border: `2px solid ${errors.loanAmount ? 'var(--error)' : 'var(--border)'}`,
                      color: 'var(--text-primary)'
                    }}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  <FileText className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" 
                            style={{ color: 'var(--text-secondary)' }} />
                  <select
                    {...register('reasonForLoan', { required: 'Please select a reason' })}
                    className="w-full pl-10 pr-4 py-3 rounded-lg outline-none appearance-none cursor-pointer"
                    style={{
                      backgroundColor: 'var(--bg)',
                      border: `2px solid ${errors.reasonForLoan ? 'var(--error)' : 'var(--border)'}`,
                      color: 'var(--text-primary)'
                    }}
                  >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  style={{
                    backgroundColor: 'var(--bg)',
                    border: `2px solid ${errors.address ? 'var(--error)' : 'var(--border)'}`,
                    color: 'var(--text-primary)'
                  }}
                />
                {errors.address && (
