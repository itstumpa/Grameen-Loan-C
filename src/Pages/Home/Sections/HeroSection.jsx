...
const HeroSection = () => {
  ...
  return (
    <div className={`min-h-screen pt-20 ${isDark ? 'bg-slate-900' : 'bg-slate-50'} transition-colors duration-300`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          >
            ...
            >
              <Award size={18} />
              <span className="text-sm font-semibold">Trusted Platform • 10,000+ Active Loans</span>
            </motion.div>
            ...
            >
              Fast, transparent, and secure microloan management. From application to approval 
              in 24 hours. Zero paperwork, maximum trust.
            </p>
          ...
          >
            {/* Main Dashboard Card */}
            <div className={`relative rounded-2xl p-6 sm:p-8 shadow-2xl border-2
              ${isDark 
        ...
        >
          ...
          <div className="text-center">
            <p className={`text-3xl font-extrabold mb-1 ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
              $5M+
            </p>
