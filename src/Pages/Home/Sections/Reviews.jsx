...
import { Star, Quote, User, MapPin, Briefcase, TrendingUp } from 'lucide-react';
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "LoanLink made it incredibly easy to get funding for my bakery expansion. The process was smooth, transparent, and the support team was amazing!",
      loanAmount: "$5,000",
    ...
    },
    {
      ...
      rating: 5,
      comment: "I needed quick funds for new equipment. LoanLink approved my loan within hours and the money was in my account the next day. Highly recommended!",
      loanAmount: "$3,500",
    ...
    },
    {
      ...
      rating: 5,
      comment: "As a student, I was worried about getting a loan. LoanLink's flexible repayment options made it possible for me to pursue my education without stress.",
      loanAmount: "$2,000",
      purpose: "Education",
      location: "Texas, USA",
    ...
    },
    {
      ...
      rating: 5,
      comment: "Outstanding service! The interest rates were fair, and the entire process was transparent. LoanLink helped me renovate my restaurant during tough times.",
      loanAmount: "$8,000",
      purpose: "Renovation",
    ...
    },
    {
      ...
      rating: 5,
      comment: "The customer support at LoanLink is exceptional. They answered all my questions and made sure I understood every detail of my loan agreement.",
      loanAmount: "$4,200",
    ...
    },
    {
      ...
      rating: 5,
      comment: "LoanLink understands the needs of small farmers. Their microloan helped me buy seeds and equipment for the season. Forever grateful!",
      loanAmount: "$6,500",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
            Real stories from real people who achieved their financial goals with LoanLink
          </p>
        </motion.div>
            ...
            {getVisibleCards().map((testimonial, idx) => {
              ...
              return (
                <motion.div
                  ...
                  onClick={() => !isActive && setActiveIndex(testimonials.findIndex(t => t.id === testimonial.id))}
                  style={{ pointerEvents: Math.abs(position) > 1 ? 'none' : 'auto' }}
                >
                  <motion.div
