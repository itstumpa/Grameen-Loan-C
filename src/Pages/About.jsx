...
const About = () => {
  ...
  // ========== MILESTONES ==========
  const milestones = [
    { year: '2010', event: 'Grameen Loan founded with a vision to empower rural communities' },
    ...
    <div className={`min-h-screen pt-28 pb-16 ${isDark ? 'bg-slate-900' : 'bg-slate-50'} transition-colors duration-300`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500">Grameen Loan</span>
          </h1>
        ...
        >
          ...
          <p className={`text-lg mb-8 max-w-2xl mx-auto ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
            Join thousands of borrowers who trust Grameen Loan for their financial needs. 
