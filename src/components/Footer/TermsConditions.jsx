...
import { FileText, Scale, AlertTriangle, DollarSign, UserX, RefreshCw, BookOpen, XCircle } from 'lucide-react';
...
const TermsConditions = () => {
  ...
  const sections = [
    {
      ...
      content: [
        {
          text: "By accessing and using LoanLink, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to these terms, please do not use our services."
        },
        {
    ...
    },
    {
      ...
      content: [
        {
          subtitle: "To use LoanLink, you must:",
          points: [
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          points: [
            "LoanLink does not provide financial, legal, or tax advice",
      ...
      content: [
        {
          subtitle: "Ownership",
          points: [
            "All content, logos, and trademarks are owned by LoanLink",
  ...
  return (
    <div className="min-h-screen py-28 px-4 md:px-8" style={{ backgroundColor: 'var(--bg)' }}>
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-6" style={{ backgroundColor: 'var(--primary)', opacity: 0.1 }}>
          ...
          <div className="mt-6 p-4 rounded-lg" style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)' }}>
            <p style={{ color: 'var(--text-secondary)' }}>
              Please read these terms and conditions carefully before using <span className="font-bold" style={{ color: 'var(--primary)' }}>Grameen Loan</span>. These terms govern your use of our platform and services.
            </p>
          </div>
        </motion.div>
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'var(--secondary)', opacity: 0.1 }}>
                  <section.icon className="w-6 h-6" style={{ color: 'var(--secondary)' }} />
                </div>
              ...
              {section.content.map((item, idx) => (
                <div key={idx} className="mb-6 last:mb-0">
                  {item.text && (
                    <p className="mb-4" style={{ color: 'var(--text-secondary)' }}>{item.text}</p>
                  )}
                  {item.subtitle && (
                    ...
                    <ul className="space-y-2">
                      {item.points.map((point, pidx) => (
                        <li key={pidx} className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-2" style={{ backgroundColor: 'var(--secondary)' }} />
        ...
        <motion.div
          ...
          style={{ backgroundColor: 'var(--surface)', border: '2px solid var(--secondary)' }}
        >
          ...
          <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
            By using LoanLink, you acknowledge that you have read, understood, and agree to be bound by these Terms & Conditions.
          </p>
          <p style={{ color: 'var(--text-secondary)' }}>
            Questions? Contact us at <span className="font-semibold" style={{ color: 'var(--secondary)' }}>legal@loanlink.com</span>
          </p>
        </motion.div>
      </motion.div>
    </div>
